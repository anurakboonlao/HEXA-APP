			...
			<div class="bg-rewa3">
				...
				<div class="row">
					<div class="col-xl-7 col-md-6">
						...
						<button class="btn-rewa1 btn-rewa5">ตะกร้าของรางวัล</button>
					</div>
					<div class="col-xl-5 col-md-6">
						<div class="bg-rewa4 font-rewa1">
							<font class="dis-rewa1">Hexa Reward Points</font><b>0,000</b><span>คะแนน</span>
				...
				<div class="scroll-box pd-rewa4 scro-rewa1">	
					<div class="row">
						<div class="col-xl-3 col-md-4 pd-rewa5">
							<img src="images/reward/img-reward1.png" width="100%"> 
							<div class="line-rewa3 hei-rewa1">
								<p class="point2">ข้อความ + เงื่อนไข</p>
								<button class="btn-order1 btn-rewa3" type="button" data-toggle="modal" data-target="#modal-reward1">รายละเอียด</button>
							</div>
						</div>
						<div class="col-xl-3 col-md-4 pd-rewa5">
							<img src="images/reward/img-reward2.png" width="100%"> 
							<div class="line-rewa3 hei-rewa1">
								<p class="point2">ข้อความ + เงื่อนไข</p>
								<button class="btn-order1 btn-rewa3" type="button" data-toggle="modal" data-target="#modal-reward1">รายละเอียด</button>
							</div>
