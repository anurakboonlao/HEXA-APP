{{ Form::open(['url' => 'front/reward/redeem', 'id' => 'form_exchange', 'method' => 'POST']) }}
<div class="row voucher_cart_area" data-type="voucher">
    <div class="col-md-6">
        <div class="left-area">
            <div class="address">
                <!-- get doctor contact -->
    ...
    <div class="col-md-6">
        <ul class="line-excha1">
            ...
            <div class="reward-list">
                <li class="item-list-1">
                    <label class="mdl-checkbox mdl-js-checkbox mdl-js-ripple-effect reward-1 check" for="reward-1" data-upgraded=",MaterialCheckbox,MaterialRipple">
                        <input type="checkbox" name="voucher_id" value="{{ $reward_data['voucher_id'] }}" 
                            id="reward-1" data-id="1" class="mdl-checkbox__input"
                            point="{{ $reward_data['point'] }}" amount="{{ $reward_data['amount'] }}"
                            onclick="sumTotalVoucher2()"
                        />
                        <div class="left-re-poin1">
                        <p>
                            <span class="pl-excha1 reward-amount">{{ $reward_data['amount'] }} บาท</span>
                            <span class="wid-excha1 reward-name" title="{{ $reward_data['voucher_name'] }}">{{ $reward_data['voucher_name'] }}</span>
                            </p>
                        </div>
                        <span class="mdl-checkbox__focus-helper"></span>
                        <span class="mdl-checkbox__box-outline">
                    ...
                    <a data-id="1" type="button" class="reward-delete" title="ลบข้อมูล">
        ...
        <div class="font-excha1 mg-excha1">
            ...
            <span id="doc_reward_total" data-value="{{ $reward_point }}"></span>
        </div>
