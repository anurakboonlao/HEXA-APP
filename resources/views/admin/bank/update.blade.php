...
@section('content-header')
    <h1> แก้ไขข้อมูลบัญชีธนาคาร</h1>
@endsection
@section('content')
<div class="row">
    <div class="col-xs-12">
    @include('admin.elements.errors_validate')
    {{ Form::open(['files' => true, 'url' => 'admin/bank/'. $bank->id, 'method' => 'PUT']) }}
        <div class="row">
            <div class="col-md-12">
                <div class="box">
                    <div class="box-body">
                            ...
                            <div class="col-md-6 col-sm-6 col-xs-12" style="padding-top: 5px;">
                                <div class="form-group">
                                    ...
                                    <div class="input-group">
                                        ...
                                        {{ Form::text('image', $bank->image, ['class' => 'form-control', 'id' => 'thumbnail-image', 'required']) }}
                                    </div>
                                    <img id="holde-image" src="{{ store_image($bank->image) }}" style="margin-top:15px;max-height:100px;"><br>
                                </div>
                            </div>
                        </div>
                        <hr>
                        <div class="row">
                            <div class="col-md-12 col-sm-12 col-xs-12">
                                {{ Form::checkbox('status', '1', $bank->status) }}
                                <label>เผยแพร่</label>
                            </div>
                        </div>
                        <hr>
