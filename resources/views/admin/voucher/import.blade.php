...
@section('content-header')
    <h1> นำเข้า Voucher </h1>
@endsection
@section('content')
<div class="row">
    <div class="col-xs-12">
    @include('admin.elements.errors_validate')
    {{ Form::open(['files' => true, 'url' => 'admin/voucher/import']) }}
        <div class="row">
            <div class="col-md-12">
                <div class="box">
                    <div class="box-body">
                        ...
                        <div class="row">
                            <div class="col-md-12 col-sm-12 col-xs-12">
                                <div class="form-group">
                                    <label for="">ไฟล์ excel * <a href="template/files/voucher-import-template.xlsx"><span class="text-blue">ตัวอย่างไฟล์</span></a></label>
