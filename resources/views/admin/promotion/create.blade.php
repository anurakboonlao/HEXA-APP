...
@section('content-header')
    <h1> เพิ่มข้อมูล โปรโมชั่น </h1>
@endsection
@section('content')
<div class="row">
    <div class="col-xs-12">
    @include('admin.elements.errors_validate')
    {{ Form::open(['files' => true, 'url' => 'admin/promotion']) }}
        <div class="row">
            <div class="col-md-12">
                <div class="box">
                    <div class="box-body">
                            ...
                            <div class="col-md-6 col-sm-6 col-xs-12">
                                <div class="form-group">
                                    ...
                                    <div class="input-group">
                                        ...
                                        {{ Form::select('product_id', $products, '', ['class' => 'form-control select2', 'required']) }} 
                                    </div>
                                </div>
                            </div>
                            <div class="col-md-6 col-sm-6 col-xs-12">
                                <div class="form-group">
                                    ...
                                    <div class="input-group">
                                        ...
                                        {{ Form::select('type', type_promotion(), '', ['class' => 'form-control select2', 'required']) }} 
                                    </div>
                                </div>
                            </div>
                        </div>
                        <div class="row">
                            ...
                            <div class="col-md-6 col-sm-6 col-xs-12">
                                <div class="form-group">
                                    ...
                                    {{ Form::text('small_text', '', ['class' => 'form-control']) }}
                                </div>
                            </div>
                        </div>
                        <div class="row">
