...
@section('content-header')
    <h1> แก้ไข VoucherBanner -  </h1>
@endsection
@section('content')
<div class="row">
    <div class="col-xs-12">
    @include('admin.elements.errors_validate')
    {{ Form::open(['files' => true, 'url' => 'admin/voucher_banner/'. $voucher_banner->id, 'method' => 'PUT']) }}
        <div class="row">
            <div class="col-md-12">
                <div class="box">
                    <div class="box-body">
                            ...
                            <div class="col-md-12 col-sm-12 col-xs-12">
                                <div class="form-group">
                                    ...
                                    <div class="input-group">
                                        ...
                                        {{ Form::text('name', $voucher_banner->name, ['class' => 'form-control', 'required']) }} 
                                    </div>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="col-md-12 col-sm-12 col-xs-12">
                                <div class="form-group">
                                    ...
                                    <div class="input-group">
                                        ...
                                        {{ Form::text('url', $voucher_banner->url, ['class' => 'form-control', 'required']) }} 
                                    </div>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="col-md-12 col-sm-12 col-xs-12">
                                <div class="form-group">
                                    ...
                                    <div class="input-group">
                                        ...
                                        {{ Form::text('sort', $voucher_banner->sort, ['class' => 'form-control']) }} 
                                    </div>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="col-md-12 col-sm-12 col-xs-12" style="padding-top: 5px;">
                                <div class="form-group">
                                    ...
                                    <div class="input-group">
                                        ...
                                        {{ Form::text('image', $voucher_banner->image, ['class' => 'form-control', 'id' => 'thumbnail-image']) }}
                                    </div>
                                    <img id="holde-image" src="{{ store_image($voucher_banner->image) }}" style="margin-top:15px;max-height:100px;"><br>
                                </div>
                            </div>
                        </div>
                        <hr>
                        <div class="row">
                            <div class="col-md-12 col-sm-12 col-xs-12">
                                {{ Form::checkbox('public', '1', $voucher_banner->public) }}
                                <label>เผยแพร่</label>
                            </div>
                        </div>
                        <hr>
