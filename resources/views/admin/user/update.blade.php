                        ...
                        <div class="row">
                            <div class="col-md-6 col-sm-12 col-xs-12">
                                <div class="form-group">
                                    ...
                                    {{ Form::select('role', role_user(), $user->role, ['class' => 'form-control']) }}
                                </div>
                            </div>
                            <div class="col-md-6 col-sm-12 col-xs-12">
                                <div class="form-group">
                        ...
                        <div class="row">
                            <div class="col-md-12 col-sm-12 col-xs-12">
                                <div class="input-group">
                                    ...
                                    {{ Form::text('image', $user->image, ['class' => 'form-control', 'id' => 'thumbnail']) }}
                                </div>
                                <img id="holde" src="{{ store_image($user->image) }}" style="margin-top:15px;max-height:100px;">
                                <br>
                            </div>
                        </div>
                        <hr>
